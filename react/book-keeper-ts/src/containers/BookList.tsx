    ...
    <div>
      ...
      {showConfirmDialog && (
        <Dialog
          message={
            bookToBeDeleted &&
            `Are you sure you want to delete the book "${bookToBeDeleted.title}"?`
          }
      ...
      {showEditDialog && (
        <BookEdit
          title={bookToBeUpdated && bookToBeUpdated.title}
          author={bookToBeUpdated && bookToBeUpdated.author}
          onSubmit={updateBook}
